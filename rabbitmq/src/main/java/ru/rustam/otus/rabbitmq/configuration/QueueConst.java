...
public class QueueConst {
    ...
    public static final String PAYMENT_CREATED_FANOUT_EXCHANGE =
            "PaymentFanout" + FANOUT_EXCHANGE_POSTFIX;
    public static final String DELIVERY_COMPLETED_FANOUT_EXCHANGE =
            "DeliveryCompleted" + FANOUT_EXCHANGE_POSTFIX;
